...
from module_sandbox.config.sampler import Sampler, SamplerConfig
from module_sandbox.training.callbacks import (
    progress_bar_scan,
    save_position,
)
from module_sandbox.training.warmup import custom_mclmc_warmup, custom_window_adaptation
from module_sandbox.types import (
    Kernel,
    ParamTree,
    PosteriorFunction,
    State,
...
def inference_loop(
    ...
    ----------
    unnorm_log_posterior : PosteriorFunction
        Unnormalized log posterior function check the `module_sandbox.types` module.
    config : SamplerConfig
